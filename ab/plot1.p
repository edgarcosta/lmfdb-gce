...
set output 'benchmark_storage_ElCurveBrowse.png'
...
bwidth=10
plot \
"n1hcpu4_mmap__Genus2Curve_Q_stats5_10000.tsv" using (bin($5,bwidth)):(1) every ::1 smooth frequency with boxes title 'MMAP, sync', \
"n1hcpu4_wt__Genus2Curve_Q_stats5_10000.tsv" using (bin($5,bwidth)):(1) every ::1 smooth frequency with boxes title 'WiredTiger, sync', \
"n1hcpu4_wtzl__Genus2Curve_Q_stats5_10000.tsv" using (bin($5,bwidth)):(1) every ::1 smooth frequency with boxes title 'WiredTiger zlib, sync'

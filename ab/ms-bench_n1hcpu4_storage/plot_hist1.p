...
set output 'ab_hist_storage_ModFormGL2.png'
...
bwidth=1
plot \
"n1hcpu4_wt__L_ModularForm_GL2_Q_holomorphic_5_6_4_a_0_5_10000.tsv" using (bin($5,bwidth)):(1) every ::1 smooth frequency with boxes title 'WT', \
"n1hcpu4_wtzl__L_ModularForm_GL2_Q_holomorphic_5_6_4_a_0_5_10000.tsv" using (bin($5,bwidth)):(1) every ::1 smooth frequency with boxes title 'WT zlib', \
"n1hcpu4_mmap__L_ModularForm_GL2_Q_holomorphic_5_6_4_a_0_5_10000.tsv" using (bin($5,bwidth)):(1) every ::1 smooth frequency with boxes title 'MMAP'

...
set output 'ab_hist_storage_L_degree1.png'
...
bwidth=1
plot \
"n1hcpu4_wt__L_degree1_5_10000.tsv" using (bin($5,bwidth)):(1) every ::1 smooth frequency with boxes title 'WT', \
"n1hcpu4_wtzl__L_degree1_5_10000.tsv" using (bin($5,bwidth)):(1) every ::1 smooth frequency with boxes title 'WT zlib', \
"n1hcpu4_mmap__L_degree1_5_10000.tsv" using (bin($5,bwidth)):(1) every ::1 smooth frequency with boxes title 'MMAP'
